...
namespace labDB_Interface {
    ...
    public partial class finalprojectDataSet2 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentID, decimal GPA) {
...
namespace labDB_Interface.finalprojectDataSet2TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ((@Is" +
                "Null_GPA = 1 AND [GPA] IS NULL) OR ([GPA] = @Original_GPA)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentID], [GPA]) VALUES (@StudentID, @GPA);\r\nSEL" +
                "ECT StudentID, GPA FROM Students WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [StudentID] = @StudentID, [GPA] = @GPA WHERE (([Stude" +
                "ntID] = @Original_StudentID) AND ((@IsNull_GPA = 1 AND [GPA] IS NULL) OR ([GPA] " +
                "= @Original_GPA)));\r\nSELECT StudentID, GPA FROM Students WHERE (StudentID = @Stu" +
                "dentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, GPA FROM dbo.Students";
        ...
        public virtual int Fill(finalprojectDataSet2.StudentsDataTable dataTable) {
        ...
        public virtual finalprojectDataSet2.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            finalprojectDataSet2.StudentsDataTable dataTable = new finalprojectDataSet2.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(finalprojectDataSet2.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentID, global::System.Nullable<decimal> Original_GPA) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_StudentID));
            if ((Original_GPA.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_GPA.Value));
            }
            else {
        ...
        public virtual int Insert(int StudentID, global::System.Nullable<decimal> GPA) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(StudentID));
            if ((GPA.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(GPA.Value));
            }
            else {
        ...
        public virtual int Update(int StudentID, global::System.Nullable<decimal> GPA, int Original_StudentID, global::System.Nullable<decimal> Original_GPA) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(StudentID));
            if ((GPA.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(GPA.Value));
            }
            else {
            ...
            if ((Original_GPA.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Original_GPA.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<decimal> GPA, int Original_StudentID, global::System.Nullable<decimal> Original_GPA) {
            return this.Update(Original_StudentID, GPA, Original_StudentID, Original_GPA);
        }
    }
