...
namespace labDB_Interface {
    ...
    public partial class finalprojectDataSet3 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentID, int UserID, decimal GPA) {
...
namespace labDB_Interface.finalprojectDataSet3TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ((@Is" +
                "Null_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@I" +
                "sNull_GPA = 1 AND [GPA] IS NULL) OR ([GPA] = @Original_GPA)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentID], [UserID], [GPA]) VALUES (@StudentID, @" +
                "UserID, @GPA);\r\nSELECT StudentID, UserID, GPA FROM Students WHERE (StudentID = @" +
                "StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentID] = @StudentID, [UserID] = @UserID, [GPA] = @GPA WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_GPA = 1 AND [GPA] IS NULL) OR ([GPA] = @Original_GPA)));
SELECT StudentID, UserID, GPA FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, UserID, GPA FROM dbo.Students";
        ...
        public virtual int Fill(finalprojectDataSet3.StudentsDataTable dataTable) {
        ...
        public virtual finalprojectDataSet3.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            finalprojectDataSet3.StudentsDataTable dataTable = new finalprojectDataSet3.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(finalprojectDataSet3.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentID, global::System.Nullable<int> Original_UserID, global::System.Nullable<decimal> Original_GPA) {
        ...
        public virtual int Insert(int StudentID, global::System.Nullable<int> UserID, global::System.Nullable<decimal> GPA) {
        ...
        public virtual int Update(int StudentID, global::System.Nullable<int> UserID, global::System.Nullable<decimal> GPA, int Original_StudentID, global::System.Nullable<int> Original_UserID, global::System.Nullable<decimal> Original_GPA) {
            ...
            if ((Original_GPA.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(Original_GPA.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> UserID, global::System.Nullable<decimal> GPA, int Original_StudentID, global::System.Nullable<int> Original_UserID, global::System.Nullable<decimal> Original_GPA) {
            return this.Update(Original_StudentID, UserID, GPA, Original_StudentID, Original_UserID, Original_GPA);
        }
    }
